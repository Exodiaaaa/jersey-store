    ...
    <section className="mt-10 rounded-lg border border-white/10 bg-white/[0.04] p-5">
      ...
      <form className="mt-5 grid gap-4" onSubmit={handleSubmit}>
        <div className="grid gap-4 sm:grid-cols-[1fr_auto]">
          ...
          <div className="space-y-2">
            <Label>Note</Label>
            <div className="flex h-11 items-center rounded-lg border border-white/10 bg-zinc-950/70 px-2">
      ...
      <div className="mt-6 grid gap-3">
        {reviews.length === 0 && (
          <p className="rounded-lg border border-white/10 bg-zinc-950/60 p-4 text-sm text-zinc-500">
            Aucun avis pour ce produit pour le moment.
          </p>
        )}
        {reviews.map((review) => (
          <article className="rounded-lg border border-white/10 bg-zinc-950/60 p-4" key={review.id}>

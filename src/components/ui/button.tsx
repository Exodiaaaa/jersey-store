...
const variants: Record<Variant, string> = {
  primary:
    "bg-[#d9dde2] text-[#060607] shadow-[0_0_26px_rgba(217,221,226,0.22)] hover:bg-white focus-visible:outline-[#d9dde2]",
  secondary:
    "border border-white/15 bg-white/[0.08] text-white hover:border-white/45 hover:bg-white/[0.12] focus-visible:outline-white/40",
  ghost: "text-zinc-200 hover:bg-white/10 hover:text-white focus-visible:outline-white/40",
  danger:

    ...
    <section className="mx-auto w-full max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
      <div className="grid gap-8 lg:grid-cols-[0.78fr_0.22fr] lg:items-start">
        ...
        <div className="rounded-lg border border-white/10 bg-white/[0.04] p-5">
          <p className="text-sm font-semibold text-zinc-400">Note moyenne</p>
          ...
          <p className="mt-2 text-sm text-zinc-500">{reviews.length} avis publie(s)</p>
        </div>
      </div>

      {reviews.length === 0 ? (
        <div className="mt-8 rounded-lg border border-white/10 bg-white/[0.04] p-8 text-center">
      ...
      <div className="mt-10 grid gap-4 rounded-lg border border-white/10 bg-black p-5 sm:grid-cols-[1fr_auto] sm:items-center">
        <div>
